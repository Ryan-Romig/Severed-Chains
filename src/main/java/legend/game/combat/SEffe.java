...
//    renderButtonPressHudElement1(buttonHudMetricsIndex, x0 + 12, y0 + 66, Translucency.B_PLUS_F, 128);
    renderText(InputCodepoints.getActionName( INPUT_ACTION_BTTL_ATTACK.get()), GPU.getOffsetX() + 85, GPU.getOffsetY() + 8, UI_WHITE_SHADOWED);
  ...
  @ScriptParam(direction = ScriptParam.Direction.IN, type = ScriptParam.Type.INT, name = "address", description = "The script address", branch = ScriptParam.Branch.FORK_JUMP)
  @Method(0x80115690L)
